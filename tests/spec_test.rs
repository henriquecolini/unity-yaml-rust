...
use unity_yaml_rust::parser::{Event, EventReceiver, Parser};
use unity_yaml_rust::scanner::TScalarStyle;
...
fn test_mapvec_legal() {
    use unity_yaml_rust::yaml::{Array, Hash, Yaml};
    use unity_yaml_rust::{YamlEmitter, YamlLoader};
